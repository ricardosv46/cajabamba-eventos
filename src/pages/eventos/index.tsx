...
const Eventos = () => {
  ...
  const isDisableAbono = true

  return (
    <>
      <OpenGraph
        title="Cajabamba - Eventos"
        link="Cajabamba"
        ...
        <div className=" flex flex-col md:flex-row justify-between max-w-[1200px] gap-x-5 items-center  mx-auto px-5 pt-10">
          <div className="">
            ...
            <p className="text-base w-full max-w-[530px] mt-5 text-justify">
              La compra de abonos está ya <strong>disponible</strong> exclusivamente a través de
              nuestra plataforma online. Compra ahora tus abonos con un {abono.descuento}% de
              descuento y disfruta de la mejor fiesta taurina de la temporada.
            </p>
          </div>
          <div className="mt-5">
              ...
              <div>
                <div className="relative mt-5 ">
                  ...
                  <div className="absolute w-full bottom-5 md:bottom-10 ">
                    <div className="flex flex-col items-center w-full gap-1 md:gap-y-2"></div>
                  </div>
                </div>
              </div>
            </div>
