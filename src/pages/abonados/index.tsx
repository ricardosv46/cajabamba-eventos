...
const colors = ['bg-[#F89F59]', 'bg-[#FFD066]', 'bg-[#FFDA99]', 'bg-[#D03B3E]', 'bg-[#E7565C]', 'bg-[#E7565C]', 'bg-[#F89F59]', 'bg-[#FFD066]']
						...
						<section className='flex-1 p-5 py-5 bg-white border rounded-lg shadow-lg lg:px-8'>
							{loading ? (
								...
								<article className='flex flex-col gap-2'>
									...
									/>
									<h2 className='mt-2 text-2xl font-bold text-center text-primary '>{abono?.titulo}</h2>
									...
									{precios?.map((item, index) => (
										<article
											...
											<div>
												...
												<p className='text-sm font-semibold leading-5 text-primary'>desde S/ {item?.precio}</p>
											</div>
					...
					<section className='z-0 flex items-start justify-center py-5'>
						<article className='border w-full  lg:w-[280px] xl:w-[380px] p-3 rounded-md flex flex-col gap-1 shadow-xl'>
							...
							<div className='w-full'>
								{/* <iframe
									src='https://www.google.com/maps/place/Plaza+de+Toros+de+Cajabamba,+Cajabamba+06351/@-7.6174372,-78.0487606,17z/data=!3m1!4b1!4m5!3m4!1s0x91b20761c240a495:0x5fc7ba61400343be!8m2!3d-7.6174185!4d-78.0465592'
									width='100%'
									height='350'
									loading='lazy'
								/> */}
